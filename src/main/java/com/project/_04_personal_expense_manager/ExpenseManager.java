...
public class ExpenseManager extends JFrame {
	...
	public ExpenseManager() {
		...
		btnViewExpense.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ViewExpense0 Exp = new ViewExpense0();
				Exp.setVisible(true);
			}
		});
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\Aemade\\Desktop\\Java_Programs\\final-project\\expensemanager-java\\images\\image 11.png"));
		lblNewLabel_2.setBounds(394, 10, 475, 513);
